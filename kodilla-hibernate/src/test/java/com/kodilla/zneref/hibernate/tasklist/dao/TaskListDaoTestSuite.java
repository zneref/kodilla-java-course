package com.kodilla.zneref.hibernate.tasklist.dao;

import com.kodilla.zneref.hibernate.task.Task;
import com.kodilla.zneref.hibernate.task.TaskFinancialDetails;
import com.kodilla.zneref.hibernate.task.dao.TaskDao;
import com.kodilla.zneref.hibernate.tasklist.TaskList;
...
public class TaskListDaoTestSuite {
    ...
    public void testTaskListDaoSaveWithTasks() {
        //Given
        Task task;
        task = new Task("Test: Learn Hibernate", 14);
        Task task2 = new Task("Test: Write some entities", 3);
        TaskFinancialDetails tfd = new TaskFinancialDetails(new BigDecimal(20), false);
        TaskFinancialDetails tfd2 = new TaskFinancialDetails(new BigDecimal(10), false);
        task.setTaskFinancialDetails(tfd);
        task2.setTaskFinancialDetails(tfd2);
        TaskList taskList = new TaskList("New list of tasks", "ToDo tasks");
