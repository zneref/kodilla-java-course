package com.kodilla.zneref.patterns2.facade.api;

import com.kodilla.zneref.patterns2.facade.Order;
import com.kodilla.zneref.patterns2.facade.ShopService;
    ...
    public void processOrder(final OrderDto order, final Long userId) throws OrderProcessingException {
        ...
        try {
            for (ItemDto item : order.getItems()) {
                LOGGER.info("Adding item " + item.getProductId() + ", " + item.getQuantity() + " pos");
